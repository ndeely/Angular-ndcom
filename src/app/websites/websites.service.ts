...
export class WebsitesService {
  ...
  private websites: Website[] = [
    new Website(
      ...
      'Ruby on Rails',
      `
<p>Ruby On Rails is a popular model-view-controller (MVC) framework for building websites using the programming language Ruby.</p>
<p>I began using Ruby on Rails in 2020 during my Computer Science college course. While I was not familiar with the programming language
Ruby at the time, I picked it up very quickly due to my experience with other object-oriented programming languages such as Java, C# and
Python.</p>
<p>I quickly fell in love with the MVC framework approach to building websites, and have continued to develop my knowledge of Ruby on Rails
after finishing the college course. I have also branched into several other MVC frameworks which are discussed on this website.</p>
...
<p>I have recently began working with Angular to develop several single page web applications. You are currently using one of these
applications to view this portfolio. The source code for this website is available on GitHub using the link below.</p>
<div class="row">
...
<p>I have worked through several tutorials on the Angular framework, building on MVC knowledge gained from studying Ruby on Rails in
my Computer Science college course. When this course ended in December 2020, I began learning about the viability of other frameworks
such as Angular and Laravel.</p>
...
applications.</p>
<p>I have recently began working with NodeJS to learn the fundamentals using a complete guide to the framework. I am still progressing
through this course, so I have not added a link to the completed website to this site yet. However, you can visit the GitHub repository for
this project using the button below.</p>
`,
...
<p>I have worked with WordPress as a Web Developer for over 3 years, and have created custom templates and plugins to use this CMS to it's
full potential.</p>
...
This is primarily due to my familiarity with PHP through working with WordPress as a web developer for several years, and my familiarity
with MVC frameworks from working on projects built using other MVC frameworks such as Ruby on Rails and Angular.</p>
